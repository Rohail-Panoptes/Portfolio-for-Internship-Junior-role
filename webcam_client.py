...
def send_webcam(host, port, file_path):
    ...
    print("[*] Webcam executable sent to the server")

    # Wait to receive the hack.avi file from the server
...
if __name__ == "__main__":
    HOST = "localhost"
    PORT = 12345
    FILE_PATH = "C:\\Users\\profe\\Desktop\\webcam\\client\\webcam.exe"
    send_webcam(HOST, PORT, FILE_PATH)
